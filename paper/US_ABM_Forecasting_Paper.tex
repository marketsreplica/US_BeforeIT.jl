...
using no post-origin information and no forecast-error fitting, and re-score on identical cells
with identical seeds. The repaired model attains the best weighted RMSE ratio of all fourteen
...
GDP-deflator inflation\}. Ranks are out of 14 scored columns.}
...
anchor; ranks are out of 14. Bias is the mean error (forecast $-$ realised) in annualised
...
first pass would have ranked 1st or 2nd of 14 at $h=8$ and $h=12$. \emph{Those are not wins.} They
...
accounting identity and correcting a misspecified estimator --- using no post-origin information and
no forecast-error fitting --- and then re-scored on identical cells with identical seeds. That arc
...
& the canonical scored result: both ABM columns, 14 models, 500 paths ---
